...
import type { ArrayElement, UnwrapPromise } from '~/types/util';
...
export interface NextPageProps<
	TParamsOrGenerateStaticParams extends
...
> {
	 ...
	 */
	params: TParamsOrGenerateStaticParams extends Record<string, string>
		? TParamsOrGenerateStaticParams
		: TParamsOrGenerateStaticParams extends GenerateStaticParamsFn<TParams>
		? ArrayElement<UnwrapPromise<ReturnType<TParamsOrGenerateStaticParams>>>
...
export interface NextApiConfig {
	api?: {
		bodyParser?: false | { sizeLimit: ByteSize };
